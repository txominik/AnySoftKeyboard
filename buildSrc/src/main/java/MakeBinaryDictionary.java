...
class MakeBinaryDictionary {
    ...
    private int dictMaxSize = 4 * 1024 * 1024;
    ...
    public void makeDictionary() throws ParserConfigurationException, SAXException, IOException {
        // System.out.println("DOS: MakeBinaryDictionary: makeDictionary: srcFilename=" + srcFilename
        //                   + ", destFilename=" + destFilename);
        // System.out.println("DOS: MakeBinaryDictionary: makeDictionary: calling populateDictionary()");
        populateDictionary(srcFilename);
        // System.out.println("DOS: MakeBinaryDictionary: makeDictionary: done with populateDictionary()");
        // System.out.println("DOS: MakeBinaryDictionary: makeDictionary: enumerateNodes(roots)");
        // enumerateNodes(roots);
        // System.out.println("DOS: MakeBinaryDictionary: makeDictionary: calling writeToDict()");
        writeToDict(destFilename);
        // System.out.println("DOS: MakeBinaryDictionary: makeDictionary: done with writeToDict()");
    }
